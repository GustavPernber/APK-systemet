...
const Product = (props: ProductProps) => {
  ...
  return (
    <a
      href={parsedProductPath()}
      target="_blank"
      rel="noopener noreferrer"
      className={`${product.assortmentText === "Ordervaror" ? "bg-gray-200" : "bg-white"} 
        ...
        <div className="  w-full flex flex-row justify-start h-[9rem] border-b-[1px] border-gray-300">
          ...
          <div className="flex flex-col justify-between w-full pl-5">
            <div className="">
              ...
              <h1 className=" font-normal mb-[-5px] ">
                {product.productNameBold}
              </h1>
              <h1 className=" font-serif font-normal text-gray-400">
                {parsedNameVintage}
              </h1>
            </div>
