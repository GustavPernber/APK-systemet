    ...
    const CategoriesContent = () => {
        return(
            <div className=' pb-3 grid place-items-start'>
                <div className='border-[1px] bg-gray-300 border-gray-300 rounded-lg overflow-hidden grid  grid-flow-row gap-[1px]
                '>
                    <button 
                    onClick={() => setCat1({url:"all", name: "Visa alla"}) }
                    className={`${cat1.url === "all" && "bg-green-400 text-white font-semibold"} 
                    bg-white transition-colors text-xl py-4 pr-8 pl-4 w-full grid place-content-start`}>
                        Visa alla
                    </button>
